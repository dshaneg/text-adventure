...
class MapNode {
  ...
  getAvailableDirections() {
    ...
    for (const edge of this.edges) {
      directions.push({ direction: edge.direction, visited: edge.headNode.visited, traversed: edge.headNode.checkTraversed() });
    }
...
function directionCompare(a, b) {
  return directionValues.get(a) - directionValues.get(b);
}
