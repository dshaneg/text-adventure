...
class StartGameHandler {
  ...
  static handle(command, game) {
    ...
    bus.commandChannel.publish({ topic: AddInventoryCommand.topic, data: new AddInventoryCommand(game.itemRepository.startSet) });
    ...
    bus.commandChannel.publish({ topic: TeleportCommand.topic, data: new TeleportCommand(game.nodeMapRepository.entryNode.id) });
  }
}
